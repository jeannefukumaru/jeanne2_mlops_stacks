...
output "jeanne2_mlops_stacks_batch_inference_job_id" {
...
output "jeanne2_mlops_stacks_experiment_id" {
  value = databricks_mlflow_experiment.experiment.id
}

output "jeanne2_mlops_stacks_experiment_name" {
...
output "jeanne2_mlops_stacks_model_name" {
...
output "jeanne2_mlops_stacks_training_job_id" {
